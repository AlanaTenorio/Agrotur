...
<html lang ="{{ app()->getLocale()}}">
  ...
  <header>
          ...
          <ul class="navbar-nav mr-auto">
            ...
            <li class="dropdown">
        			...
        			<ul class="dropdown-menu">
          			<li><a href="editarCliente">Remover Cliente</a></li>
   ...
   <!-- Exibição do form de remocao -->

    <div class="col-md-8 order-md-1">
          <h4 class="mb-3">Remover Cliente</h4>
          ...
          <form class="needs-validation" novalidate>
            <div class="row">
              ...
              <div class="input-group">
                ...
                <input type="text" name="cpf" disabled="disabled" class="form-control" id="username" placeholder="xxxxxxxxxxx" required value="{{$cliente->cpf}}"> {{ $errors->first('cpf')}} <br/>
            ...
            <div class="mb-3">
              ...
              <input type="text" name="telefone" disabled="disabled" class="form-control" id="address" placeholder="81998541236" required value="{{$cliente->telefone}}"> {{ $errors->first('telefone')}} <br/>
              <div class="invalid-feedback">
            ...
            <hr class="mb-4">
            <button class="btn btn-primary btn-lg btn-block" type="submit">Apagar</button>
