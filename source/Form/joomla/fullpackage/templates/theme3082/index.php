  ...
  <body class="<?php echo $option . " view-" . $view . " task-" . $task . " itemid-" . $itemid . " body__" . $pageClass;if( $detect->isMobile() || $detect->isTablet() ){echo ' mobile';}?>">
    ...
    <div id="wrapper">
      <div class="wrapper-inner">
        ...
        <!-- Mainbottom -->
        <div id="mainbottom-row"<?php if( !$detect->isMobile() && !$detect->isTablet() && ((int)$detect->version('IE') == '' || (int)$detect->version('IE') > 8 )){ ?> data-stellar-background-ratio="0.5"<?php } ?>>
          <div class="row-container">
            <div class="<?php echo $containerClass; ?>">
    ...
    <?php }
    if( !$detect->isMobile() && !$detect->isTablet() && ((int)$detect->version('IE') == '' || (int)$detect->version('IE') > 8 ) && (!$detect->version('iOS') || $detect->version('iOS') !== "X")){ ?>
