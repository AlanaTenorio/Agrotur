...
?>
<div class="mod-article-single services mod-article-single__<?php echo $moduleclass_sfx; ?>" id="module_<?php echo $module->id; ?>">
	...
	<div class="item__module" id="item_<?php echo $item->id; ?>">
		...
		<<?php echo $item_heading; ?> class="item-title">
			...
			<a href="<?php echo $item->link;?>"><?php echo wrap_with_span($item->title);?></a>
			<?php else :
