...
?>
<div class="mod-article-single image mod-article-single__<?php echo $moduleclass_sfx; ?>" id="module_<?php echo $module->id; ?>">
	<div class="item__module" id="item_<?php echo $item->id; ?>">
		...
		<figure class="item_img img-intro img-intro__<?php echo htmlspecialchars($imgfloat); ?>">
			...
			<?php endif; ?>
				...
				<figcaption><?php echo wrap_with_span(htmlspecialchars($item_images->image_intro_caption)); ?></figcaption>
				<?php endif;
