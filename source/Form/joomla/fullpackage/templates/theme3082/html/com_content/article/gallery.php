...
<article class="page-item page-item__gallery page-item__<?php echo $this->pageclass_sfx?>">
	...
	<div class="page-gallery_img">
		<figure class="item_img img-full img-full__<?php echo htmlspecialchars($imgfloat); ?> span5">
			<a class="touchGalleryLink zoom articleGalleryZoom" href="<?php echo JURI::base().htmlspecialchars($images->image_fulltext); ?>">
        <span class="zoom-bg"></span>
		    <span class="zoom-icon"></span>
				<img src="<?php echo JURI::base().htmlspecialchars($images->image_fulltext); ?>" alt="<?php echo htmlspecialchars($images->image_fulltext_alt); ?>">
